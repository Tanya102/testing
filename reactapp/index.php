...
<div id="root"><div class="search-app">
	<div class="container-fluid">
		...
		<div class="search-results">
			<div class="search-results__article-type-filters">
				<ul class="filter-tabs nav nav-tabs">
					...
					<li role="presentation" class="filter-tab nav-item"><a data-article-type="serious" class="filter-tab__button nav-link active" href="/serious" id="serious">serious</a></li>
					<li role="presentation" class="filter-tab nav-item"><a data-article-type="light" class="filter-tab__button nav-link " href="/light" id="light">light</a></li>
				</ul>

				<select class="form-control filter-select" name="all" id="all">
            ...
            <div>
            	<nav>
            	<ul class="pagination search-results-pagination" id="page_data">
		...
		<script>
            ...
            // 		$("page_data").html(params);

            // 	}
            	// httpRequest('getresults.php', 'GET', params, 'list');
